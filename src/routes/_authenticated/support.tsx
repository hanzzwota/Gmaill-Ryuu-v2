    ...
    <div className="space-y-5">
      ...
      <NeoCard>
        ...
        <div className="mt-3 space-y-3">
          {(tickets.data ?? []).length === 0 ? (
            ...
            (tickets.data ?? []).map((t) => (
              <div key={t.id} className="rounded-md border-[3px] border-ink bg-card p-3 shadow-neo-sm">
      ...
      <NeoCard>
        ...
        <div className="mt-3 space-y-2">
          {(faqs.data ?? []).map((f) => (
            <details key={f.id} className="rounded-md border-[3px] border-ink bg-card p-3 shadow-neo-sm">
              <summary className="cursor-pointer font-display text-sm font-bold">{f.question}</summary>
